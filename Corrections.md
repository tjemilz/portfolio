...
## Capacité de pouvoir modifier les photos et les galeries

## Vrac

- ✅ Résoudre l'erreur dans panel admin : gallery/modifier photos → json error
...
- Ajouter une option pour imprimer la photo (pour les proches)
    ...
    - Petit cadre 10x15cm
    - Autre (à discuter)
- Faire une page avec des articles
    - Possibilité de liker les articles
- Reprendre le code pour la sécurité
