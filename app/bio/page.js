    ...
    <div className="min-h-screen bg-cream">
            ...
            <div className="lg:pt-12">
              ...
              <div className="space-y-6 text-gray-600 font-light leading-relaxed">
                ...
                <p>
                  ...
                  Je cherche à capturer la <span className="text-gray-900">beauté de ce monde</span>.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Sony a6700</h4>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Sigma 18-50mm f/2.8</h4>
                  <p className="mt-1 text-sm text-gray-500 font-light">
      ...
      <section className="py-24 px-6 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-gray-400 max-w-xl mx-auto font-light">
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 mt-10 px-8 py-4 bg-accent text-white rounded-full hover:bg-accent-dark transition-all duration-300 group"
          >
      ...
      <section className="py-20 px-6 bg-cream">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-500 font-light">Envie de découvrir mon travail ?</p>
          <Link
            href="/galleries"
            className="inline-flex items-center gap-3 mt-4 text-gray-900 hover:text-accent transition-colors group"
          >
