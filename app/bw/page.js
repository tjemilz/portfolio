...
export default function BWPage() {
  ...
  return (
    <div className="flex flex-col items-center px-6 py-12 mt-16">
      <h1 className="text-6xl sm:text-7xl md:text-8xl font-bold mb-6 text-center text-black">B&W</h1>
      
      <p className="text-lg text-center max-w-2xl mb-12 text-gray-700">
        This collection is a snapshot of time. Creating a feeling of stop, the black and white emphasizes moments of life.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
        {images.map((image, index) => (
          ...
          >
            <Image
              src={`/bw/${image}`}
              alt={`Black and White photograph ${index + 1}`}
              fill
