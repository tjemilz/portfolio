        ...
        <section className="pt-32 pb-16 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="animate-pulse text-center">
              <div className="h-4 w-24 bg-gray-200 rounded mx-auto mb-6"></div>
              <div className="h-16 w-80 bg-gray-200 rounded mx-auto mb-8"></div>
    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <h1 className="font-serif text-2xl text-gray-900 mb-3">Une erreur est survenue</h1>
          <p className="text-gray-500 mb-8">{error}</p>
          <Link
            href="/galleries"
            className="inline-flex items-center gap-2 px-6 py-2.5 bg-gray-900 text-white rounded-full text-sm hover:bg-gray-800 transition-colors"
          >
    ...
    <div className="min-h-screen bg-cream">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <nav className="mb-8">
              <Link 
                href="/galleries" 
                className="inline-flex items-center gap-2 text-accent text-sm tracking-[0.2em] uppercase font-medium hover:text-accent-dark transition-colors"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
            ...
            <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-gray-900">
              {gallery?.name || slug}
            </h1>
            
            {gallery?.description && (
              <p className="mt-6 text-lg md:text-xl text-gray-500 max-w-3xl mx-auto font-light leading-relaxed italic">
                "{gallery.description}"
              </p>
            )}
      ...
      <section className="py-16 px-6 border-t border-gray-200">
        <div className="max-w-7xl mx-auto text-center">
          <Link
            href="/galleries"
            className="inline-flex items-center gap-3 text-gray-600 hover:text-accent transition-colors group"
          >
