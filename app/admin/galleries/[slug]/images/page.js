  ...
  return (
    <AdminLayout>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <div className="flex items-center gap-2 text-sm text-slate-grey mb-2">
          ...
          <h1 className="text-2xl font-bold text-space-indigo">
      ...
      <div className="bg-white rounded-xl shadow p-4 mb-6">
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={deselectAll}
              className="px-4 py-2 text-sm text-slate-grey bg-slate-grey/10 rounded-lg hover:bg-gray-200 transition-colors"
            >
              Tout désélectionner
            </button>
          </div>
