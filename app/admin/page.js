...
const AdminDashboardPage = () => {
  ...
  return (
    <AdminLayout>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-space-indigo">Dashboard</h1>
        <p className="text-slate-grey mt-1">Bienvenue dans le panel d'administration</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          {statCards.map((card) => (
            ...
            >
              ...
              <p className="text-slate-grey text-sm">{card.name}</p>
              <p className="text-3xl font-bold text-space-indigo mt-1">{card.value}</p>
            </a>
          ))}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow p-6">
          <h2 className="text-lg font-semibold text-space-indigo mb-4">Actions rapides</h2>
          <div className="space-y-3">
            <a
              href="/admin/galleries"
              className="flex items-center gap-3 p-3 bg-accent/10 rounded-lg text-accent hover:bg-accent/20 transition-colors"
            >
            ...
            <a
              href="/admin/images"
              className="flex items-center gap-3 p-3 bg-space-indigo/10 rounded-lg text-space-indigo hover:bg-space-indigo/20 transition-colors"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a
              href="/admin/users"
              className="flex items-center gap-3 p-3 bg-slate-grey/10 rounded-lg text-slate-grey hover:bg-slate-grey/20 transition-colors"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <h2 className="text-lg font-semibold text-space-indigo mb-4">Informations système</h2>
          <div className="space-y-4">
            <div className="flex justify-between items-center py-2 border-b border-slate-grey/10">
              <span className="text-slate-grey">Version de l'application</span>
              <span className="font-medium text-space-indigo">1.0.0</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-slate-grey/10">
              <span className="text-slate-grey">Backend</span>
              <span className="font-medium text-space-indigo">Django 5.2.8</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-slate-grey/10">
              <span className="text-slate-grey">Frontend</span>
              <span className="font-medium text-space-indigo">Next.js 15</span>
            </div>
            <div className="flex justify-between items-center py-2">
              <span className="text-slate-grey">API Status</span>
